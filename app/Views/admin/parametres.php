...
<body>
    <div class="navbar-admin">
        <div style="font-size: 1.5rem; font-weight: 700;">⚙️ Paramètres système</div>
        <div>
    ...
    <div class="container-custom">
        ...
        <div class="card-box">
            <h2 class="h4 mb-3"><?= $editingParametre ? 'Modifier le paramètre' : 'Ajouter un paramètre' ?></h2>
            <form method="POST" action="<?= base_url('admin/parametres/save') ?>" class="row g-3">
                ...
                <div class="col-12 d-flex gap-2">
                    <button type="submit" class="btn btn-dark"><?= $editingParametre ? 'Mettre à jour' : 'Ajouter' ?></button>
                    ...
                    <?php foreach ($parametres as $parametre): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="<?= base_url('admin/parametres/delete/' . $parametre['id']) ?>" style="display:inline;" onsubmit="return confirm('Supprimer ce paramètre ?');">
                                    <?= csrf_field() ?>
